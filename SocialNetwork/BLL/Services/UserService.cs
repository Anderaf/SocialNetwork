...
namespace SocialNetwork.BLL.Services
{
    public class UserService
    {
        ...
        public IEnumerable<User> GetFriendsById(int id)
        {
            return friendRepository.FindAllByUserId(id).Select(fe => FindById(fe.friend_id));
        }

        public void AddFriend(FriendAddingData friendAddingData)
        {
            var userEntity = userRepository.FindByEmail(friendAddingData.FriendEmail);
            if (userEntity == null)
        ...
        private User ConstructUserModel(UserEntity userEntity)
        {
            ...
            var friends = GetFriendsById(userEntity.id);
